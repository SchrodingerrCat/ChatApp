    ...
    <div className='flex h-screen items-center justify-center'>
        <form  onSubmit={handleSubmit(onSubmit)} className='border  border-white px-6  py-2 rounded-md space-y-3  w-96'>
            <h1 className='text-2xl text-center'>
                Chat<span className='text-purple-500 font-semibold'>App</span>
            </h1>
            ...
            <div className='flex justify-between'>
                ...
                <input type='submit' value='Signup'className='text-white bg-purple-500 px-1 p-1 cursor-pointer rounded-lg'></input>
            </div>
        </form>
    </div>
    </>
